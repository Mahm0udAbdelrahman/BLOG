                ...
                <div class="navbar-nav-wrap">
                    <ul class="navbar-nav flex-column">
                        <li class="nav-item {{ request()->segment(2) == '' ? 'active' : '' }}">
                            <a class="nav-link" href="{{route('dashboard.main')}}"  data-target="#dash_drp">
                        ...
                        <li class="nav-item {{ request()->segment(2) == 'setting' ? 'active' : '' }}">
                            <a class="nav-link link-with-badge" href="{{ route('dashboard.setting.index') }}"  data-target="#app_drp">
