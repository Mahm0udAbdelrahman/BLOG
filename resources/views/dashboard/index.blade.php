									...
									<div class="card-body">
										<div class="user-activity user-activity-sm">
											...
											<div class="media">
												<div class="media-img-wrap">
													<div class="avatar avatar-xs">
														<img src="{{asset('dashboard/dist/img/avatar3.jpg')}}" alt="user" class="avatar-img rounded-circle">
													</div>
												</div>
												<div class="media-body">
													<div>
													...
													<div class="d-flex">
														<a href="#" class="w-75p mr-10"><img class="card-img-top rounded" src="{{asset('dashboard/dist/img/slide1.jpg')}}" alt="Card image cap"></a>
														<a href="#" class="w-75p mr-10"><img class="card-img-top rounded" src="{{asset('dashboard/dist/img/slide2.jpg')}}" alt="Card image cap"></a>
														<a href="#" class="w-75p mr-10"><img class="card-img-top rounded" src="{{asset('dashboard/dist/img/slide3.jpg')}}" alt="Card image cap"></a>
													</div>
												</div>
											</div>
											<div class="media">
											...
											<div class="media">
												<div class="media-img-wrap">
													<div class="avatar avatar-xs">
														<img src="{{asset('dashboard/dist/img/avatar4.jpg')}}" alt="user" class="avatar-img rounded-circle">
													</div>
												</div>
												<div class="media-body">
													<div>
											...
											<div class="media">
												...
												<div class="media-body">
													...
													<div class="d-flex">
														<a href="#" class="w-75p mr-10"><img class="card-img-top rounded" src="{{asset('dashboard/dist/img/slide4.jpg')}}" alt="Card image cap"></a>
													</div>
												</div>
											</div>
											<div class="media">
												<div class="media-img-wrap">
													<div class="avatar avatar-xs">
														<img src="{{asset('dashboard/dist/img/avatar6.jpg')}}" alt="user" class="avatar-img rounded-circle">
													</div>
												</div>
												<div class="media-body">
													<div>
